            ...
            <div class="wrapper_card">
                <div class="card card--rounded wrapper__back">
                    <div class="card__header">
                        <img class="card__image" src="https://bit.ly/3hXV52k" alt="south park series banner" />
                    </div>
                    <div class="card__body">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <button class="btn btn--transparent btn--circle">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="card__icon" width="24" height="24"
                        ...
                        <p class="card__title text">
                            <span class="text--bold">S17:E1</span>Say một phút tan trường phong nguyệt
                        </p>
