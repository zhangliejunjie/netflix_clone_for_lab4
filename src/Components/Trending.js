...
export default function Treding({ filmList }) {
    ...
    return (
        <div className="wrapper">
            ...
            <section id="section2">
                ...
                <a href="#section3" className="arrow__btn right-arrow">›</a>
            </section>
            ...
            <div className="overlay cards" id='popup1'>
                <div className="wrapper_cards" id='openPopUp' href='#popup1' onClick={() => { setFilm(film) }}>
