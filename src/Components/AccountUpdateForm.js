...
import { fetchAccounts, updateAnAccount, accountsSelector, addAnAccount } from "../store/slices/accountSlice";

// ----------------------------------------------------------------------

export default function AccountUpdateForm({ news, onClose, isLoad }) {
    ...
    const validate = values => {
        ...
        if (formik.errors.name === undefined && formik.errors.email === undefined && formik.errors.phone === undefined
    ...
    const formik = useFormik({
        initialValues: {
            ...
            "email": news.email,
            "phone": news.phone,
            "birthday": moment(news.birthday).format('yyyy-MM-DD'),
        ...
        validate,
        onSubmit: values => {
            dispatch(updateAnAccount(news.id, values));
            isLoad();
            onClose();
    ...
    return (
        ...
        <form onSubmit={formik.handleSubmit}>
            <Stack sx={{
                ...
                <Typography variant="h3"> Update Account {news.id}</Typography>
                <Box display={'flex'}>
                    <TextField
                        sx={{
                            ...customeInput,
